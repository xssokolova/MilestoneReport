...
ngram5 <- readRDS("Appfiles/ngram5.rds")
ngram4 <- readRDS("Appfiles/ngram4.rds")
ngram3 <- readRDS("Appfiles/ngram3.rds")
ngram2 <- readRDS("Appfiles/ngram2.rds")
ngram1 <- readRDS("Appfiles/ngram1.rds")
